...
func run() -> void:
	...
	var report:Dictionary=JSON.parse_string(FileAccess.get_file_as_string("res://assets/characters/captain/captain-illustrated.json"))
	assert(report.atlas_sha256==FileAccess.get_sha256("res://assets/characters/captain/captain-illustrated.png"))
	assert(report.source_sha256==FileAccess.get_sha256("res://../../evidence/illustrated-walk/side-cycle.png"))
	assert(report.manifest_sha256==FileAccess.get_sha256("res://../../assets-production/characters/captain/illustrated-captain.json"))
	...
	for direction in ["front","back","left"]:
		var prefix:String="res://assets/characters/captain/captain-"+direction
		...
		assert(provenance.manifest_sha256==FileAccess.get_sha256("res://../../assets-production/characters/captain/illustrated-captain-"+direction+".json"))
