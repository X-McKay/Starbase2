...
const OUTCROPS := [
	...
	{"at":Vector2(-8,-29),"size":Vector3(3.0,1.2,2.5)},
	{"at":Vector2(16,-26),"size":Vector3(3.0,1.4,2.6)},
	{"at":Vector2(41,-10),"size":Vector3(3.0,1.6,2.6)},
	{"at":Vector2(33,9),"size":Vector3(2.8,0.9,2.4)},
	{"at":Vector2(12,35),"size":Vector3(2.6,1.1,2.2)},
	...
	{"at":Vector2(33,25),"size":Vector3(2.2,1.2,2.0)}
]
const CRATERS := [
	Vector3(-31,2.0,-27),Vector3(-22,1.9,-27),Vector3(0,2.0,-29),
