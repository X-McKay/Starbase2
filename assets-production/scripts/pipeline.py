...
plan = json.loads((ROOT / "assets-production/batches/engineering-polish/plan.json").read_text())
...
if key not in stages:
    ...
    if args.stage == "image":
        ...
        concept = (ROOT / "assets-production/structures/engineering/concepts/concept-v1.png").read_bytes()
    ...
    item = {
        ...
        "concept_sha256": hashlib.sha256(
            (ROOT / "assets-production/structures/engineering/concepts/concept-v1.png").read_bytes()
        ).hexdigest(),
    }
    stages[key] = item
    save()
