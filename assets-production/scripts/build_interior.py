...
bpy.ops.wm.save_as_mainfile(compress=True, filepath=str(root / "assets-production/structures/engineering-prototype/blender/engineering-interior.blend"))
...
bpy.ops.export_scene.gltf(
    filepath=str(root / "apps/world/assets/structures/engineering-prototype/engineering-interior.glb"),
    export_format="GLB",
