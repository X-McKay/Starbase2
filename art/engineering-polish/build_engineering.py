...
OUT = ROOT / "apps/world/art/engineering-polish"
...
bpy.ops.wm.save_as_mainfile(
    filepath=str(ROOT / "art/engineering-polish/engineering-architecture.blend")
)
batches = []
...
(ROOT / "art/engineering-polish/layout.json").write_text(json.dumps(layout, indent=2) + "\n")
