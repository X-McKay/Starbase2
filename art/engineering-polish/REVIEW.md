...
The built-in image tool produced [concept v1](concept-v1.png). Meshy received it
...
`repair-continuous.tscn` using `art/meshy-blender/connect_colony.py` and restore the
...
Follow-up: the player now uses [CyberCat Vanguard](../cybercat-vanguard/README.md),
