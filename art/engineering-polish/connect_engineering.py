...
[ext_resource type="PackedScene" path="res://art/engineering-polish/engineering-shell.glb" id="1"]
[ext_resource type="PackedScene" path="res://art/engineering-polish/exterior.glb" id="2"]
...
"""
(WORLD / "buildings/exteriors/engineering-polished.tscn").write_text(shell)
text = f"[gd_scene load_steps={len(d['blocks']) + 4} format=3]\n"
for i, path, kind in [
    (1, "art/engineering-polish/engineering-interior.glb", "PackedScene"),
    (2, "art/engineering-polish/reactor.glb", "PackedScene"),
    (3, "buildings/engineering_effects.gd", "Script"),
]:
...
(WORLD / "buildings/interiors/engineering-polished.tscn").write_text(text)
p = WORLD / "buildings/definitions/repair.tres"
s = p.read_text()
s = re.sub(
    r"^exterior_scene = .*$",
    'exterior_scene = "res://buildings/exteriors/engineering-polished.tscn"',
    s,
    flags=re.M,
)
s = re.sub(
    r"^interior_scene = .*$",
    'interior_scene = "res://buildings/interiors/engineering-polished.tscn"',
    s,
    flags=re.M,
)
s = re.sub(
