...
OUT = ROOT / "apps/world/art/colony-3d"
...
for kind, (left, back, width, depth, accent) in BUILDINGS.items():
    ...
    source = ROOT / f"art/meshy-blender/{kind}-building.blend"
...
(ROOT / "art/meshy-blender/colony-layout.json").write_text(json.dumps(manifest, indent=2) + "\n")
